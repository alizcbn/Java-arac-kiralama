...
import arackiralama.yoneticipaneli;
import java.awt.event.ActionListener;
import java.awt.event.ActionEvent;

public class aracsil extends JFrame {
	...
	public aracsil() {
		...
		lblModel.setBounds(10, 284, 430, 201);
		...
		sil.setBackground(new Color(128, 0, 0));
		sil.setForeground(new Color(255, 255, 255));
		sil.setBounds(834, 675, 118, 23);
		contentPane.add(sil);
		
		JButton yeniliste = new JButton("G\u00DCNCEL L\u0130STE");
		yeniliste.addMouseListener(new MouseAdapter() {
			@Override
		...
		yeniliste.setForeground(Color.WHITE);
		yeniliste.setBackground(new Color(128, 0, 0));
		yeniliste.setBounds(704, 675, 129, 23);
		contentPane.add(yeniliste);
		...
		scrollPane.setBounds(5, 345, 585, 357);
		...
		sil.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String idd,sql_sorgu;

				idd = id.getText();
				
				
				
				sql_sorgu = "DELETE FROM arac_listesi WHERE id="+idd;
				
				baglanti.sil(sql_sorgu);
				
				
					
					JOptionPane.showMessageDialog(null, "SÝLME ÝÞLEMÝ TAMALANDI ");
