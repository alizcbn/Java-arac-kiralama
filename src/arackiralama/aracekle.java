...
public class aracekle extends JFrame {
	...
	public aracekle() {
		...
		lblNewLabel_8.setBounds(500, 246, 461, 306);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				sql_sorgu = "INSERT INTO arac_listesi (id,marka,model,plaka,þanzuman,yýl,yakýt,fiyat) VALUES (" +
				
                  idd + ",'" +mrk + "'," + "'" + mdl + "'," + "'" + plk + "'," + "'" + szn + "'," +   yl + "," + "'" + ykt + "'," + fyt + ")" 
						;
		...
		btnNewButton.setBounds(380, 595, 121, 32);
		...
		id = new JTextField();
		id.setColumns(10);
		id.setBounds(380, 262, 121, 20);
		contentPane.add(id);
		
		marka = new JTextField();
		marka.setBounds(380, 299, 121, 20);
		contentPane.add(marka);
		marka.setColumns(10);
		
		model = new JTextField();
		model.setColumns(10);
		model.setBounds(380, 338, 121, 20);
		contentPane.add(model);
		
		plaka = new JTextField();
		plaka.setColumns(10);
		plaka.setBounds(380, 375, 121, 20);
		contentPane.add(plaka);
		
		sanzuman = new JTextField();
		sanzuman.setColumns(10);
		sanzuman.setBounds(380, 415, 121, 20);
		contentPane.add(sanzuman);
		
		yýl = new JTextField();
		yýl.setColumns(10);
		yýl.setBounds(380, 457, 121, 20);
		contentPane.add(yýl);
		
		yakit = new JTextField();
		yakit.setColumns(10);
		yakit.setBounds(380, 496, 121, 20);
		contentPane.add(yakit);
		
		fiyat = new JTextField();
		fiyat.setColumns(10);
		fiyat.setBounds(380, 541, 121, 20);
		...
		JButton btnListe = new JButton("G\u00DCNCEL L\u0130STE");
		btnListe.addMouseListener(new MouseAdapter() {
		...
		btnListe.setBackground(new Color(128, 0, 0));
		btnListe.setBounds(245, 595, 121, 32);
