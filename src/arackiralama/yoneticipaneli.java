...
public class yoneticipaneli extends JFrame {
	...
	public yoneticipaneli() {
		...
		lblModel.setBounds(37, 288, 430, 201);
		...
		JButton btnNewButton_1 = new JButton("ARA\u00C7 EKLE");
		
		btnNewButton_1.setForeground(Color.WHITE);
		btnNewButton_1.setBackground(new Color(153, 0, 0));
		btnNewButton_1.setBounds(196, 30, 172, 54);
		contentPane.add(btnNewButton_1);
		
		JButton btnAraGncelle = new JButton("ARA\u00C7 G\u00DCNCELLE");
		
		btnAraGncelle.setForeground(Color.WHITE);
		btnAraGncelle.setBackground(new Color(153, 0, 0));
		btnAraGncelle.setBounds(376, 30, 172, 54);
		contentPane.add(btnAraGncelle);
		
		JButton btnAraSil = new JButton("ARA\u00C7 S\u0130L");
		btnAraSil.setForeground(Color.WHITE);
		
		btnAraSil.setBackground(new Color(153, 0, 0));
		btnAraSil.setBounds(556, 30, 172, 54);
		contentPane.add(btnAraSil);
		
		JButton btnAraBilgisi = new JButton("ARA\u00C7 B\u0130LG\u0130LER\u0130");
		btnAraBilgisi.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				
				aracbilgisi bilgi = new aracbilgisi();
				bilgi.setVisible(true);
			}
			@Override
			public void mouseEntered(MouseEvent arg0) {
				btnAraBilgisi.setBackground(new Color(0, 0, 0) );
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnAraBilgisi.setBackground(new Color(153, 0, 51) );
			}
		});
		
		btnAraBilgisi.setForeground(Color.WHITE);
		btnAraBilgisi.setBackground(new Color(153, 0, 0));
		btnAraBilgisi.setBounds(738, 30, 172, 54);
		contentPane.add(btnAraBilgisi);
		...
		JLabel lblNewLabel_9 = new JLabel("ARA\u00C7 L\u0130STES\u0130");
		lblNewLabel_9.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_9.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNewLabel_9.setBounds(288, 650, 160, 34);
		...
		txtvolkswogen.setText("WOLKSWOGEN");
		...
		btnAraSil.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAraSil.setBackground(new Color(0, 0, 0) );
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnAraSil.setBackground(new Color(153, 0, 51) );
			}
			@Override
			public void mousePressed(MouseEvent e) {
		...
		btnAraGncelle.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAraGncelle.setBackground(new Color(0, 0, 0) );
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnAraGncelle.setBackground(new Color(153, 0, 51) );
			}
			@Override
			public void mousePressed(MouseEvent e) {
				aracguncelle guncelle = new aracguncelle();
