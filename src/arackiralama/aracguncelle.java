...
public class aracguncelle extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					aracguncelle frame = new aracguncelle();
...
JLabel bmw2 = new JLabel("");
		...
		JLabel lblAraEkle = new JLabel("ARA\u00C7 G\u00DCNCELLE");
		...
		gnc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				sql_sorgu = "UPDATE arac_listesi SET id="+idd+",  "+
							"marka='"+mrk+"',  model='"+mdl+
							"',  plaka='"+plk+"',  þanzuman='"+szn+"',  yýl="+yl+",  yakýt='"+ykt+"', fiyat="+fyt+"       WHERE id="+idd;
					
				//System.out.println(sql_sorgu);
				baglanti.update(sql_sorgu);
				
				
				JOptionPane.showMessageDialog(null, "GÜNCELLEME ÝÞLEMÝ TAMALANDI ");
